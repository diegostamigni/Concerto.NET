...
[StateMachineTransitionExecutorFor(ImportProfileTrigger.UploadAvatar)]
public class ImportProfileUploadAvatarStateMachineTransitionExecutor
	: IStateMachineTransitionExecutor<ImportProfileState, ImportProfileTrigger>
{
	private readonly IBus bus;

	public ImportProfileUploadAvatarStateMachineTransitionExecutor(IBus bus)
		=> this.bus = bus;
		...
		StateMachine<ImportProfileState, ImportProfileTrigger>.Transition transition)
	{
		...
		await stateMachineHandler.FireAsync(ImportProfileTrigger.UploadSearchIndex, response);
	}
}